...
function VerifyEmailContent() {
  ...
  if (state === "no-token") {
    return (
      <AuthCard title="Invalid link" subtitle="This verification link is missing or malformed." backLink={{ label: "Back to sign in", href: "/" }}>
        <div className="flex justify-center py-2">
  ...
  // error state
  return (
    <AuthCard title="Link expired" subtitle={errMsg || "This link has expired or has already been used."} backLink={{ label: "Back to sign in", href: "/" }}>
      <div className="flex justify-center py-2">
