              ...
              <div className="hidden md:flex flex-col gap-3 pt-2">
                ...
                {church.address ? (
                  <div className="relative h-[260px] rounded-2xl overflow-hidden shadow-2xl border border-white/20">
                    <iframe
                      src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyA7xWwgUTo39HymdPPsjL5zxPlZbHDJZyo&q=${encodeURIComponent(`${church.address}, ${church.suburb} ${church.state} ${church.postcode}`)}&zoom=15`}
