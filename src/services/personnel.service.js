...
// assertChurchInConference is imported from lib/church.js —
// it correctly handles nested church hierarchies (church → district → conference).
// The previous local implementation only checked parentCode = conferenceCode,
// missing churches nested under intermediate tiers (districts, fields, etc.).
